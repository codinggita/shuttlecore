      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
          <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-[1400px] mx-auto min-h-[80vh] flex flex-col">
            ...
            <motion.div variants={itemVariants} className="dashboard-card !p-8 flex-1 border-[var(--primary)] border shadow-[0_0_30px_rgba(var(--primary-rgb),0.1)]">
              <div className="flex flex-col items-center justify-center h-full text-center py-20">
                <div className="w-24 h-24 bg-[var(--primary)]/10 rounded-full flex items-center justify-center mb-6 animate-pulse">
                   <span className="material-symbols-outlined text-5xl text-[var(--primary)]">alt_route</span>
                </div>
                <h2 className="text-2xl font-black text-main tracking-tight mb-2">Engine Synchronizing...</h2>
                <p className="text-muted text-sm max-w-md mx-auto mb-8 leading-relaxed">
                  The routing algorithm is calculating the most optimal pathways across the decentralized mesh. Real-time rendering will commence shortly.
                </p>
                <div className="flex gap-4">
                  <button onClick={() => navigate("/dashboard")} className="btn-primary !px-8 !py-3">Return to Simulation</button>
                </div>
              </div>
            </motion.div>
