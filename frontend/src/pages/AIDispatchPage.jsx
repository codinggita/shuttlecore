    ...
    <div className="flex h-screen bg-[var(--background)] text-[var(--text-main)] overflow-hidden transition-colors duration-300 relative font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
          ...
          {/* Footer Area */}
          <footer className="mt-12 py-12 border-t border-[var(--border)] flex flex-col md:flex-row justify-between items-center gap-8 px-10">
            <p className="text-[10px] font-black text-muted uppercase tracking-[0.3em] opacity-40">
              © 2024 SHUTTLECORE LOGISTICS. NODE_042 ACTIVE.
            </p>
            <div className="flex gap-10">
              {["Network", "Security", "Privacy"].map((link) => (
                <a
                  key={link}
