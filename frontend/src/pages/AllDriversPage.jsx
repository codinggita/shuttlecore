        ...
        <header className="h-20 flex items-center justify-between px-4 md:px-8 header-bg transition-colors duration-300 z-30">
          <div className="flex items-center gap-4 flex-1">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted uppercase font-bold tracking-wider">Fleet Operator Directory - 9 Total</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
          <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-[1400px] mx-auto">
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {[
                { label: "Total Drivers", value: "9", icon: "people", color: "text-[var(--primary)]" },
                { label: "Active Duty", value: "8", icon: "check_circle", color: "text-emerald-400" },
                { label: "In Training", value: "1", icon: "school", color: "text-amber-400" },
                { label: "Avg Score", value: "88%", icon: "trending_up", color: "text-blue-400" },
              ].map((stat, i) => (
